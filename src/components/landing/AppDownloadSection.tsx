        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <a
              ...
              className="group flex items-center gap-3 rounded-xl border border-white/10 bg-white/[0.03] px-5 py-3 transition-all hover:border-violet-500/30 hover:bg-violet-500/5"
            >
              ...
              <div>
                ...
                <div className="text-sm font-bold text-white leading-tight">{t.app.appStore}</div>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <div className="text-sm font-bold text-white leading-tight">{t.app.googlePlay}</div>
              </div>
            </a>
          </div>
