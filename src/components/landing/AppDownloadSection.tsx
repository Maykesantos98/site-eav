        ...
        >
          ...
          <div className="mt-10 grid grid-cols-2 gap-3 sm:flex sm:gap-4">
            ...
            >
              ...
              <div>
                <div className="text-[10px] text-stone-500 leading-tight sm:text-[11px]">{t.app.availableOn1}</div>
            ...
            >
              ...
              <div>
                <div className="text-[10px] text-stone-500 leading-tight sm:text-[11px]">{t.app.availableOn2}</div>
