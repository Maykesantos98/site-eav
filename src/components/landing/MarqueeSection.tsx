    ...
    <div className="flex overflow-hidden">
      ...
      >
        {[...items, ...items].map((item, i) => (
          <div
            key={`${item}-${i}`}
            className="flex flex-shrink-0 items-center gap-2 rounded-full border border-white/[0.06] bg-white/[0.02] px-5 py-2.5 text-sm font-medium text-stone-400 whitespace-nowrap"
          >
